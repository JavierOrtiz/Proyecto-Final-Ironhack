...
User.create email:'jefe@site.es', name:'Aitor', last_name: 'Garcia', invitationHash: SecureRandom.hex(13), password:'w2kpro0108', password_confirmation:'w2kpro0108', photo:'http://placehold.it/250x250', status:'activo', role:'user', plan_id: 2
...
Event.create title: 'SuperMartxe', description:'La fiesta que todos desean', capacity:1000, user_id:1, commission: '1,60', locate:'Humanes de Madrid', date: '17/06/2015', house:'Fabrik', price: 15
Event.create title: 'Megatron', description:'¿Pijo yo?', capacity:500, user_id:1, commission: '1,65', locate:'Atocha, Madrid', date: '12/01/2016', house:'Kapital', price: 15
